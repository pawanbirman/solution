...
public class LoginActivity extends AppCompatActivity {
    ...
    private TextView AdminLink, NotAdminLink,forgetPassword,NotRegisterLink;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NotRegisterLink=(TextView)findViewById(R.id.login_register);
        ...
        NotRegisterLink.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v)
            {
                Intent intent = new Intent(LoginActivity.this, RegisterWithOtpActivity.class);
                startActivity(intent);
